...
Since the selection matrix is $$\boldsymbol{D} = \begin{bmatrix}\boldsymbol{1}_T & \boldsymbol{0} & \cdots & \boldsymbol{0} \\ \boldsymbol{0} & \boldsymbol{1}_T & \cdots & \boldsymbol{0} \\ \vdots &\ \vdots & \ddots & \vdots \\ \boldsymbol{0} & \boldsymbol{0} & \cdots & \boldsymbol{1}_T\end{bmatrix},$$ 
...
which is the solution by regressing $\{y_{it}-\bar{y}_i\}$ on $\{\boldsymbol{x}_{it}-\bar{\boldsymbol{x}}_i\}$, where $\bar{y}_i = T^{-1}\sum_{i=1}^{T}y_{it}$ and $\bar{\boldsymbol{x}}_{i} = T^{-1}\sum_{i=1}^{T}\boldsymbol{x}_{it}$.
